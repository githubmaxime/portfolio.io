...
/**
 * Effet d'inclinaison de l'élément
 */
...
const initTilt = function (event) {
  ...
  /** obtenir la position centrale de l'élément d'inclinaison */
...
window.addEventListener("mousemove", function (event) {
  ...
  /** position du point du curseur */
  cursors[0].style.left = `${posX}px`;
  cursors[0].style.top = `${posY}px`;

  /** position du contour du curseur */
  setTimeout(function () {
...
/** ajouter une classe survolée lors du survol de la souris sur hoverElements */
...
/** supprimer la classe survolée lors du passage de la souris sur hoverElements */
